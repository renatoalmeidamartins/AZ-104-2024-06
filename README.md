...
- [Soft delete for VMs](https://learn.microsoft.com/en-us/azure/backup/soft-delete-virtual-machines)
- [Support matrix for the MARS agent](https://learn.microsoft.com/en-us/azure/backup/backup-support-matrix-mars-agent)
